            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                ...
                <ul className="text-sm text-gray-300 space-y-1">
                  <li>✅ {t('discord.benefits.channels')}</li>
                  <li>✅ {t('discord.benefits.communication')}</li>
                  <li>✅ {t('discord.benefits.history')}</li>
                  <li>✅ {t('discord.benefits.voice')}</li>
                </ul>
              </div>
