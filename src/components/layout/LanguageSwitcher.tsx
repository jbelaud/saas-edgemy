...
// SVG Flags as components - Full size with rounded corners
const FlagFR = () => (
  <svg className="w-full h-full rounded-lg" viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg">
...
const FlagEN = () => (
  <svg className="w-full h-full rounded-lg" viewBox="0 0 60 30" xmlns="http://www.w3.org/2000/svg">
...
const FlagDE = () => (
  <svg className="w-full h-full rounded-lg" viewBox="0 0 5 3" xmlns="http://www.w3.org/2000/svg">
...
const FlagIT = () => (
  <svg className="w-full h-full rounded-lg" viewBox="0 0 3 2" xmlns="http://www.w3.org/2000/svg">
...
const FlagES = () => (
  <svg className="w-full h-full rounded-lg" viewBox="0 0 750 500" xmlns="http://www.w3.org/2000/svg">
