      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-block px-6 py-2 mb-8 bg-white/5 border border-white/10 rounded-full backdrop-blur-sm">
            <span className="text-gray-300 text-sm font-semibold">Notre mission</span>
          </div>
            ...
            {[
              {
                ...
                title: "Communauté",
                description: "Une plateforme pensée par et pour les passionnés de poker"
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                title: "Qualité",
                description: "Coachs vérifiés et sessions de haute qualité garanties"
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                title: "Simplicité",
                description: "Une expérience fluide du premier contact au suivi long terme"
              }
            ].map((value, index) => (
              <div
                key={index}
