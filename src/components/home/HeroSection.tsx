      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            {/* Secondary CTA for Coaches */}
            <button
              onClick={() => {
                const event = new CustomEvent('openCoachModal');
                window.dispatchEvent(event);
              }}
              className="text-gray-400 hover:text-amber-400 text-sm font-medium transition-colors underline underline-offset-4 decoration-gray-600 hover:decoration-amber-400"
            >
              Tu es coach ? Rejoins la plateforme →
            </button>
          </div>
        </div>
      </div>
