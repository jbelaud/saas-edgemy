  ...
  const features = [
    {
      ...
      description: "Tous nos coachs sont sélectionnés et vérifiés pour garantir un coaching de qualité."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Chaque session est adaptée à ton niveau et tes objectifs spécifiques."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Transactions 100% sécurisées via Stripe. Tes données sont protégées."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Dashboard complet pour suivre tes sessions, notes et évolution."
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Une plateforme pensée pour maximiser ta progression au poker
          </p>
        </div>
