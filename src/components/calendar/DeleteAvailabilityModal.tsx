        ...
        {mode === "choice" ? (
          ...
          <div className="space-y-3">
            {onMove && (
              <button
                onClick={onMove}
                className="w-full px-4 py-3 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 text-blue-400 rounded-lg font-medium transition-all flex items-center justify-center gap-2"
              >
